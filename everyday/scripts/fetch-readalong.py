...
root=Path(__file__).resolve().parents[1]/'vendor/models/Xenova/opus-mt-en-zh'
host='https://modelscope.cn'
model='Xenova/opus-mt-en-zh'
wanted={'config.json','generation_config.json','tokenizer_config.json','tokenizer.json','README.md','onnx/encoder_model_quantized.onnx','onnx/decoder_model_merged_quantized.onnx'}
